    ...
    <div className="flex">
      {[...Array(5).keys()].map((index) => (
        <StarIcon
          ...
          className={clsx(
            'h-5 w-5',
            rating > index ? 'fill-[#f4c016]' : 'fill-stone-400',
          )}
        />
      ))}
    </div>
...
function Review({
  ...
  return (
    <figure
      className={clsx(
        'animate-fade-in rounded-lg bg-[#141414] p-6 opacity-0 border border-[#222222]',
        className,
      )}
  ...
  return (
    ...
    >
      <Container>
        <h2
          id="reviews-title"
          className="text-3xl font-medium tracking-tight text-stone-50 sm:text-center"
        >
          Everyone is changing their life with Pocket.
        </h2>
        <p className="mt-2 text-lg text-stone-400 sm:text-center">
