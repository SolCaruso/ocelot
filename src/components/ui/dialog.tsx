...
function DialogOverlay({
  ...
  // TODO: If you want to target only CommandDialog overlays, add a prop or className and check for it here.
  // For now, this will apply the modal overlay style to all overlays.
  return (
